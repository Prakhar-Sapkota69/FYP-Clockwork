        ...
        try:
            ...
            self.cursor.execute("""
                INSERT INTO games (
                    ...
                    playtime, metadata_fetched, poster_url, background_url,
            ...
            """, (
                ...
                game.poster_url, game.background_url, game.release_date,
        ...
        try:
            ...
            for col_name, col_type in columns_to_add.items():
                if col_name not in existing_columns:
                    self.cursor.execute(f"ALTER TABLE games ADD COLUMN {col_name} {col_type}")
